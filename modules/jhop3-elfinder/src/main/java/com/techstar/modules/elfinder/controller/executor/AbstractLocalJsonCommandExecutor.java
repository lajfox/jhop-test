...
public abstract class AbstractLocalJsonCommandExecutor extends AbstractLocalCommandExecutor {

	@Override
	final public void execute(FsService fsService, Param param, HttpServletRequest request,
		...
		try (PrintWriter writer = response.getWriter();) {
			execute(fsService, param, request, servletContext, json);
	...
	protected abstract void execute(FsService fsService, Param param, HttpServletRequest request,
