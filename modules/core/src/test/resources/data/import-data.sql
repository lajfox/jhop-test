...
insert into ss_invoice (ID ,INVNO , NAME  ,AMOUNT ,TAX ,TOTAL ,NOTE ,CLOSED ,SHIPVIA) values('1',1000,'A1',300,500,800,'BB1','C1','D1');
insert into ss_invoice (ID ,INVNO , NAME  ,AMOUNT ,TAX ,TOTAL ,NOTE ,CLOSED ,SHIPVIA) values('2',1000,'A2',350,550,900,'BB2','C2','D2');
