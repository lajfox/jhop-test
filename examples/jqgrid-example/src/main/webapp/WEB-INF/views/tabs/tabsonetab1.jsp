...
<table id="tabsonetab1" class="autowidth autoheight"></table>
<div id="ptabsonetab1"></div>
...
$("#tabsonetab1").jqGrid('navGrid','#ptabsonetab1',{edit:false,add:false,del:false});

//设置grid高度
$("#tabsonetab1").jqGrid('gridHeight',{height:-5});  
