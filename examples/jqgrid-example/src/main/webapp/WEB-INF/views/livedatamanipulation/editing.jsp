...
<br>
<input type="BUTTON" id="b${uuid}" value="编辑选择的行" />
...
$("#b${uuid}").click(function(){
	var gr = jQuery("#${uuid}").jqGrid('getGridParam','selrow');
	if( gr != null ) {
		jQuery("#${uuid}").jqGrid('editGridRow',gr,{reloadAfterSubmit:false});
	}else {
