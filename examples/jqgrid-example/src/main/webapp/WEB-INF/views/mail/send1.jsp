...
<script type="text/javascript">
	jQuery().ready(function() {		
		...
		$('#sData', '#mailButton').click(function(e) {
...
<span>
	<form method="post" name="mailForm" id="mailForm" class="FormGrid" action="${ctx}/mail/send1"
		...
		<table class="EditTable" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				...
				<tr class="FormData">
					...
					<td class="DataTD"><input type="text"
						class="FormElement ui-widget-content ui-corner-all" name="subject"
						id="subject" value="测试"/></td>
				</tr>

				<tr class="FormData">
					<td class="CaptionTD">内容</td>
					<td class="DataTD"><textarea rows="5" cols="60"
							class="FormElement ui-widget-content ui-corner-all" id="text"
							name="text">测试内容
						</textarea></td>
				</tr>
	...
	<table id="mailButton" class="EditTable" cellspacing="0"
