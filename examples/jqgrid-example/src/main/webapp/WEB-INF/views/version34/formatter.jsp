	...
	datatype: "json",
   	...
   	colModel:[
		...
		{name:'shipvia',index:'shipvia',width:70, 
   			editable: true,edittype:"select",editoptions:{value:'${shipviaValue}'},
   			formatter:"select",
   			stype:'select',searchoptions:{sopt:['eq','ne'],value:"${shipviaValue}"}
   			},   		
...
jQuery("#frmgrid").jqGrid('navGrid','#pfrmgrid',{edit:false,add:false,del:false});
