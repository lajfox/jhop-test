...
insert into SS_PERMISSION (ID,NAME,DISPLAY_NAME,EXPANDED_ ,LEAF_ ,LEVEL_ ,LOADED_ ,ORDER_ ,PARENT_ ) values('1','sys:manager','系统管理',false,false,0,true,1,null);
insert into SS_PERMISSION (ID,NAME,DISPLAY_NAME,EXPANDED_ ,LEAF_ ,LEVEL_ ,LOADED_ ,ORDER_ ,PARENT_ ) values('2','user:manager','用户管理',false,false,1,true,2,'1');
insert into SS_PERMISSION (ID,NAME,DISPLAY_NAME,EXPANDED_ ,LEAF_ ,LEVEL_ ,LOADED_ ,ORDER_ ,PARENT_ ) values('3','user:view','查看',false,true,2,true,2,'2');
insert into SS_PERMISSION (ID,NAME,DISPLAY_NAME,EXPANDED_ ,LEAF_ ,LEVEL_ ,LOADED_ ,ORDER_ ,PARENT_ ) values('4','user:edit','编辑',false,true,2,true,3,'2');
insert into SS_PERMISSION (ID,NAME,DISPLAY_NAME,EXPANDED_ ,LEAF_ ,LEVEL_ ,LOADED_ ,ORDER_ ,PARENT_ ) values('5','user:delete','删除',false,true,2,true,4,'2');
